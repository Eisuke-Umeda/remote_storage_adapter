...
import (
	...
	"gopkg.in/alecthomas/kingpin.v2"
        ...
        "github.com/Eisuke-Umeda/remote_storage_adapter/graphite"
        "github.com/Eisuke-Umeda/remote_storage_adapter/influxdb"
        "github.com/Eisuke-Umeda/remote_storage_adapter/opentsdb"
...
func parseFlags() *config {
	...
	a.Flag("monitor-name", "The monitor name will be used as tag").
		Default("prometheus-monitor").StringVar(&cfg.monitorName)
